...
namespace ExitGames.Client.DemoParticle
{
    ...
    public class GameLogic : LoadBalancingClient
    {
        ...
        /// </remarks>
        protected override Room CreateRoom(string roomName, bool isVisible, bool isOpen, byte maxPlayers, Hashtable customGameProperties, string[] propsListedInLobby)
        {
